...
u1 = User.create(:name => 'Jade Davis', :email => 'jade0@gmail.com', :remote_image_url => 'https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-ash4/p206x206/1379382_519501864799896_1109009103_n.png',
                 :password => 'jade', :password_confirmation => 'jade')
u2 = User.create(:name => 'Angie Gove', :email => 'ang.gove@gmail.com', :remote_image_url => 'https://fbcdn-sphotos-e-a.akamaihd.net/hphotos-ak-ash3/p206x206/734207_10151392905806407_1656555031_n.jpg',
...
b1 = Bar.create(:name => 'Palmer & Co', :remote_image_url => 'http://media.au.timeout.com/contentFiles/remote_image_url/galleries/palmer-and-co/palmer-and-co-018.jpg',
...
b2 = Bar.create(:name => 'Baxter inn', :remote_image_url => 'http://thebaxterinn.com/img/main_home.png', :description => 'underground wiskey bar with a libary of whiskeys, enjoy an old fashion here!',
